...
func ParseWithNamespace(data []byte, v any, config NamespaceConfig) (string, error) {
...
//	  <ElementName>...</ElementName>
//	</idPkg:ElementName>
func MarshalWithNamespace(v any, config NamespaceConfig, domVersion string) ([]byte, error) {
...
func getElementName(v any) string {
